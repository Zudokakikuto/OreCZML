...
public class AttitudePathAlongOrbit {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final GeodeticPoint mexico = new GeodeticPoint(FastMath.toRadians(23.6345), FastMath.toRadians(-102.5528), 0);
        final TopocentricFrame topocentricMexico = new TopocentricFrame(earth, mexico, "Mexico");

        final GeodeticPoint madagascar = new GeodeticPoint(FastMath.toRadians(-18.7669), FastMath.toRadians(46.8691), 0);
        final TopocentricFrame topocentricMadagascar = new TopocentricFrame(earth, madagascar, "Madagascar");

        final GeodeticPoint portMoresby = new GeodeticPoint(FastMath.toRadians(-9.4790), FastMath.toRadians(147.1494), 0);
        final TopocentricFrame topocentricPortMoresby = new TopocentricFrame(earth, portMoresby, "Port Moresby");

        final GeodeticPoint maracaibo = new GeodeticPoint(FastMath.toRadians(10.6410), FastMath.toRadians(-71.6074), 0);
        ...
        attitudesSequence.addSwitchingCondition(attitudeProviderToEarth, attitudeProviderMexico, earthToMexico, true, false, 10.0, AngularDerivativesFilter.USE_R, null);
        attitudesSequence.addSwitchingCondition(attitudeProviderMexico, attitudeProviderToEarth, mexicoToEarth, false, true, 10.0, AngularDerivativesFilter.USE_R, null);

        attitudesSequence.addSwitchingCondition(attitudeProviderToEarth, attitudeProviderMadagascar, earthToMadagascar, true, false, 10.0, AngularDerivativesFilter.USE_R, null);
        attitudesSequence.addSwitchingCondition(attitudeProviderMadagascar, attitudeProviderToEarth, madagascarToEarth, false, true, 10.0, AngularDerivativesFilter.USE_R, null);

        attitudesSequence.addSwitchingCondition(attitudeProviderToEarth, attitudeProviderPortMoresby, earthToPortMoresby, true, false, 10.0, AngularDerivativesFilter.USE_R, null);
        attitudesSequence.addSwitchingCondition(attitudeProviderPortMoresby, attitudeProviderToEarth, portMoresbyToEarth, false, true, 10.0, AngularDerivativesFilter.USE_R, null);

        attitudesSequence.addSwitchingCondition(attitudeProviderToEarth, attitudeProviderMaracaibo, earthToMaracaibo, true, false, 10.0, AngularDerivativesFilter.USE_R, null);
        attitudesSequence.addSwitchingCondition(attitudeProviderMaracaibo, attitudeProviderToEarth, maracaiboToEarth, false, true, 10.0, AngularDerivativesFilter.USE_R, null);

        // Add a switching condition between mexico and maracaibo, because they are close enough
        attitudesSequence.addSwitchingCondition(attitudeProviderMexico, attitudeProviderMaracaibo, mexicoToMaracaibo, true, false, 10.0, AngularDerivativesFilter.USE_R, null);
