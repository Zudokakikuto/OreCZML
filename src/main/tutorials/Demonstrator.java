...
public class Demonstrator {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final GeodeticPoint kirunaFrame = new GeodeticPoint(FastMath.toRadians(67.8558), FastMath.toRadians(20.2253), 10);
        ...
        final GeodeticPoint trollFrame = new GeodeticPoint(FastMath.toRadians(-72.006), FastMath.toRadians(2.529), 10);
        ...
        final KeplerianOrbit initialOrbit = new KeplerianOrbit(7878000, 0, FastMath.toRadians(98), 0, FastMath.toRadians(0), FastMath.toRadians(0), PositionAngleType.MEAN, EME2000, startDate, Constants.WGS84_EARTH_MU);
