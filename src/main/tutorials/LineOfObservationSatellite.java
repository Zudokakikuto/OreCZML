...
import org.orekit.czml.CzmlObjects.CzmlPrimaryObjects.LineOfObservation;
...
public class LineOfObservationSatellite {

    private LineOfObservationSatellite() {
        // empty
    }
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final Header header = new Header("Setup of the sinusoidal attitude of a satellite with a line of sight", clock);
        ...
        // Creation of the line of observation of the satellite
        ...
        final FieldOfView fov = new DoubleDihedraFieldOfView(Vector3D.PLUS_J, Vector3D.PLUS_I, FastMath.toRadians(40), Vector3D.PLUS_K, FastMath.toRadians(20), 2);
        final LineOfObservation lineOfObservation = new LineOfObservation(satellite, fov, initialFovBody);
        file.addObject(lineOfObservation);
