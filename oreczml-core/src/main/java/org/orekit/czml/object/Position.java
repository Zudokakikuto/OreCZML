...
public class Position {
    ...
    public String getReferenceFrame() {
        if (ReferenceFrame != null) {
            ...
            throw new OreCzmlException(OreCzmlMessages.EMPTY_FRAME);
        }
    }
    ...
    public double getVx() {
        if (vx != 0.0) {
            ...
            throw new OreCzmlException(OreCzmlMessages.EMPTY_VX);
        }
    }
    ...
    public double getVy() {
        if (vy != 0.0) {
            ...
            throw new OreCzmlException(OreCzmlMessages.EMPTY_VY);
        }
    }
    ...
    public double getVz() {
        if (vz != 0.0) {
            ...
            throw new OreCzmlException(OreCzmlMessages.EMPTY_VZ);
        }
    }
