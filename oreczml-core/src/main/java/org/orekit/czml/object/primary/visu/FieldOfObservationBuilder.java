...
public class FieldOfObservationBuilder {
    ...
    /**
     * Custom ID of the field of observation.
     */
    private String customID = FieldOfObservation.DEFAULT_ID;
     ...
     * @return : The field of observation with a custom ID.
     */
    public FieldOfObservationBuilder withCustomID(final String customIDInput) {
