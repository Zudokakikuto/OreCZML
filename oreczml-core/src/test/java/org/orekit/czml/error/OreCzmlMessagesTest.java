 ...
 */
public class OreCzmlMessagesTest
    extends
    AbstractTest {
    ...
    @Nested
    class OreCzmlMessagesTests {

        /**
         * Collision OreCzml messages test.
         */
        @Test
        @DefaultDataContext
        @DisplayName("Collision messages test")
        void CollisionOreCzmlMessagesTests() {
            Assertions
                .assertEquals("Satellite are not close enough to build a collision object.",
                              OreCzmlMessages.NOT_CLOSE_ENOUGH
                                  .getSourceString());
        ...
        @Test
        @DefaultDataContext
        void CzmlFileOreCzmlMessagesTests() {
            Assertions
                .assertEquals("No objects have been written.",
                              OreCzmlMessages.HEADER_ALONE.getSourceString());
            Assertions
            ...
            Assertions.assertEquals("String generation error.",
                                    OreCzmlMessages.STRING_NOT_GENERATED
                                        .getSourceString());
        ...
        @Test
        @DefaultDataContext
        void GroundTrackOreCzmlMessagesTests() {
            Assertions
                .assertEquals("The ground tracks are empty, either the file is already written or the ground track is not build with a constellation.",
                              OreCzmlMessages.EMPTY_GROUND_TRACKS
                                  .getSourceString());
        ...
        @Test
        @DefaultDataContext
        void SpacecraftOreCzmlMessagesTests() {
            Assertions
                .assertEquals("The spacecraft did not display the orientation, maybe you tried to use an AttitudePointing, please use the withDisplayAttitude() method first.",
                              OreCzmlMessages.NO_ORIENTATION_DISPLAYED
                                  .getSourceString());
            Assertions
                .assertEquals("The initial state of the spacecraft does not have a keplerian period.",
                              OreCzmlMessages.NO_ORBIT_FOR_KEPLERIAN_PERIOD
                                  .getSourceString());
        ...
        @Test
        @DefaultDataContext
        void VisibilityConeOreCzmlMessagesTests() {
            Assertions
                .assertEquals("The Visibility cone was not defined with a given spacecraft.",
                              OreCzmlMessages.NO_SAT_VISIBILITY_CONE
                                  .getSourceString());
        ...
        @Test
        @DefaultDataContext
        void PositionOreCzmlMessagesTests() {
            Assertions.assertEquals("Height is not defined.",
                                    OreCzmlMessages.EMPTY_POSITION_HEIGHT
                                        .getSourceString());
            Assertions.assertEquals("x is not defined.",
                                    OreCzmlMessages.EMPTY_X.getSourceString());
            Assertions.assertEquals("y is not defined.",
                                    OreCzmlMessages.EMPTY_Y.getSourceString());
            Assertions.assertEquals("z is not defined.",
                                    OreCzmlMessages.EMPTY_Z.getSourceString());
            Assertions.assertEquals("Position Type is not defined.",
                                    OreCzmlMessages.POSITION_TYPE_UNKNOWN
                                        .getSourceString());
