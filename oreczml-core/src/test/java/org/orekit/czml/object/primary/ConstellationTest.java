    ...
    void ConstellationConstructorTest()
        ...
        final Constellation constellation =
            Constellation.builder(propagators, finalDate, header)
                .withModel(ISSModel).withHeader(header).withCustomId("CustomID")
                .displayAttitude().displayOnlyOnePeriod().build();

        final String pathFile =
            loadResources("templateFile/primary/ConstellationTemplate.txt");
