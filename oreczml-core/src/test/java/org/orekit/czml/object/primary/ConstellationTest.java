 ...
 */
public class ConstellationTest extends AbstractTest {
     ...
     */
    @Test
    void ConstellationConstructorTest() throws IOException, URISyntaxException {
        ...
        final double[][] tolerances2 = NumericalPropagator.tolerances(10, secondOrbit,
                OrbitType.CARTESIAN);
        final double[][] tolerances3 = NumericalPropagator.tolerances(10, thirdOrbit,
                OrbitType.CARTESIAN);
        final double[][] tolerances4 = NumericalPropagator.tolerances(10, fourthOrbit,
                OrbitType.CARTESIAN);
        final double[][] tolerances5 = NumericalPropagator.tolerances(10, fifthOrbit,
                OrbitType.CARTESIAN);

        final AdaptiveStepsizeIntegrator firstIntegrator = new DormandPrince853Integrator(0.001,
                1000.0,
                tolerances1[0], tolerances1[1]);
        final AdaptiveStepsizeIntegrator secondIntegrator = new DormandPrince853Integrator(0.001,
                1000.0,
                tolerances2[0], tolerances2[1]);
        final AdaptiveStepsizeIntegrator thirdIntegrator = new DormandPrince853Integrator(0.001,
                1000.0,
                tolerances3[0], tolerances3[1]);
        final AdaptiveStepsizeIntegrator fourthIntegrator = new DormandPrince853Integrator(0.001,
                1000.0,
                tolerances4[0], tolerances4[1]);
        final AdaptiveStepsizeIntegrator fifthIntegrator = new DormandPrince853Integrator(0.001,
                1000.0,
