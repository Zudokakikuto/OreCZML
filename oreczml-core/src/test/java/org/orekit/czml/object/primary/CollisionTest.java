...
public class CollisionTest extends AbstractTest {
     ...
     */
    @Test
    void CollisionConstructorTest() throws URISyntaxException, IOException {
        ...
        final double[][] tolerances1 = NumericalPropagator.tolerances(10, initialOrbit1,
                OrbitType.CARTESIAN);
        final double[][] tolerances2 = NumericalPropagator.tolerances(10, initialOrbit2,
                OrbitType.CARTESIAN);
        ...
        final List<StateCovariance> covariances1 = covariancePropagation(satellite1, propagator1, stateCovariance,
                header);
