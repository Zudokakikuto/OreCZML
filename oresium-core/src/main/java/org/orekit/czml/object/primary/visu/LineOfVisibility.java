...
public class LineOfVisibility
    ...
    public void displayTriangle() {
        if (lines.isEmpty()) {
            ...
            throw new OresiumException(OresiumMessages.NOT_A_SINGLE_TRIANGLE_LINE);
        }
    }

    public void displaySingleTriangle(final int i) {
        if (lines.isEmpty()) {
            throw new OresiumException(OresiumMessages.NOT_A_MULTIPLE_TRIANGLE_LINE);
        } else {
    ...
    public List<CzmlShow> getShowList() {
        if (showList != null) {
            ...
            throw new OresiumException(OresiumMessages.NOT_A_SINGLE_SAT_OR_STATION);
        }
    }
