...
/**
 * This tutorial provides an example of how to set up inter-visualization
 * between satellites of the same constellation.
 */
public class InterVisuConstellationExample {
    ...
    public static void main(final String[] args)
        ...
        // Build of the Header
        final Header header =
            new Header("Setup of the visualisation inter-constellation of 5 satellites",
        ...
        final double[][] tolerances4 =
            NumericalPropagator.tolerances(TutorialUtils.POSITION_TOLERANCE,
                                           fourthOrbit, OrbitType.CARTESIAN);
        final double[][] tolerances5 =
            NumericalPropagator.tolerances(TutorialUtils.POSITION_TOLERANCE,
                                           fifthOrbit, OrbitType.CARTESIAN);
